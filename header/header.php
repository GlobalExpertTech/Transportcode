      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html" class="mt-2"> <p>Kranti Transport</p> 
            </a>
          </div>
          <?php
...
<ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <a href="users.php" class="nav-link"><i data-feather="user-check"></i><span>Manage Users</span></a></li>
