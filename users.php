    ...
    <div class="section-body">
      ...
      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
        ...
        <tbody>
          ...
          $selectquery = "SELECT * FROM `userlogin`";
          //    echo $selectquery;
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModal">Create New User</h5>
...
<!-- Row Three -->
            ...
            <button type="button" class="btn btn-primary m-t-15  form-control" onclick="addparty()">Add New User</button>
          </form>
        </div>
      </div>
    </div>
