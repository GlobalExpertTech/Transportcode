...
<head>
  ...
  <title>Kranti Transport Login</title>
  <!-- General CSS Files -->
...
<body>
  ...
  <div id="app">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <center>
              <h2 class="text-cenetr">Kranti Transport</h2>
              </center>
             <!-- <br>
    ...
    if(isset($_POST['login']))
    {
      ...
      //   echo $mobile_number;
        $log=mysqli_query($con,"select * from userlogin where mob='$mobile_number' and password='$Password'") or die (mysqli_error($connect));
...
?>
                <form method="POST" class="needs-validation" novalidate="">
                  <div class="form-group">
                    ...
                    <input id="number" type="number" class="form-control" value="8412003013" name="mobile_number" tabindex="1" required autofocus>
