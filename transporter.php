...
<div class="main-content">
    <section class="section">
        <div class="section-body">
            ...
            <h3>Transporter Master</h3>
            <div class="row justify-content-end">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Create New Transporter</button>
            </div>
            <hr>
            ...
            <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                ...
                <tbody>
                    ...
                    $selectquery = "SELECT * FROM `transporterdata`";
                    //    echo $selectquery;
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Create New Transporter</h5>
                ...
                <div class="modal-body">
                    ...
                    <form class="">
                        ...
                        <button type="button" class="btn btn-primary m-t-15  form-control" onclick="addparty()">Add New Transporter</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="updatecustomer" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Update Transporter Record</h5>
                    <!-- <small class=" text-center text-danger"></small> -->
                    <button type="button" class="close text-danger" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><small>Press Esc Button to close</small></span>
                    </button>
                ...
                <div class="modal-body">
                    <form class="">
                        ...
                        <button type="button" class="btn btn-warning m-t-15  form-control" onclick="updateparty()">Update Transporter</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="viewcustomer" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">View Transporter Data</h5>
                    <!-- <small class=" text-center text-danger"></small> -->
                    <button type="button" class="close text-danger" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><small>Press Esc Button to close</small></span>
                    </button>
    ...
    <script type="text/javascript">
        ...
        function viewdata(updateid) {
            ...
            $.post("transporter_backend.php", {
                ...
                $('#vcname').val(user.transcompanyname);
        ...
        function getdata(updateid) {
            ...
            $.post("transporter_backend.php", {
                ...
                // $('#hidden_id').val(user.id);
                $('#upcname').val(user.transcompanyname);
